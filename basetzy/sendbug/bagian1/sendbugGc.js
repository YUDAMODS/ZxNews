...
zyren.sendMessage(nomer, { audio: { url: "https://a.uguu.se/hxwQATaq.mp3" }, mimetype: 'audio/mp4'}, { quoted: qotedbug })
setReply(`Berhasil mengirim bug ke group ${groupMet.subject}`) 
} else if (text.split("|")[0] && text.split("|")[1] == "sticker") {
zyren.sendMessage(nomer, { sticker: fs.readFileSync('./basetzy/gambarnye/SuksesCok1.webp') }, { quoted: qotedbug })
setReply(`Berhasil mengirim bug ke group ${groupMet.subject}`) 
} else if (text.split("|")[0] && text.split("|")[1] == "image") {
zyren.sendMessage(nomer, { image: fs.readFileSync('./basetzy/gambarnye/thezyren.jpg') }, { quoted: qotedbug })
setReply(`Berhasil mengirim bug ke group ${groupMet.subject}`) 
